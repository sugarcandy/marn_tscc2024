...
class NeuralNetwork(nn.Module):
    ...
    def mfan(self, x_tid, x_text, y, loss, i, total, params, pgd_word):
        ...
        loss_cons = SupConLoss(temperature=3.0)
...
def train_and_test(model):
    ...
    nn.load_state_dict(torch.load(
        "exp_result/pheme/exp_description/best_model_in_each_config/Thread-1_configsingle3_best_model_weights_mfanlstmwithclip_nllLoss_temp3.0"))
