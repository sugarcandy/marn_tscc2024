...
class MFAN(NeuralNetwork):
    def __init__(self, config, adj, original_adj):
        ...
        self.model_fusion = VLTransformer2(fusion_dim, config) # 去掉模态特定信息
...
def train_and_test(model):
    ...
    nn.load_state_dict(torch.load(
        "exp_result/pheme/exp_description/best_model_in_each_config/Thread-1_configsingle3_best_model_weights_mfanlstmwithclip_nllLoss_wosp"))
