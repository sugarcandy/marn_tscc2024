...
def train_and_test(model):
    ...
    config['save_path'] = os.path.join(res_dir, args.thread_name + '_' + 'config' + args.config_name.split(".")[
        0] + '_best_model_weights_' + model_suffix + "lstmwithclip_nllLossdropout0.1")
    ...
    nn.load_state_dict(torch.load(
        "exp_result/pheme/exp_description/best_model_in_each_config/Thread-1_configsingle3_best_model_weights_mfanlstmwithclip_nllLossdropout0.1"))
