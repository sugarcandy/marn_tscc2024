...
"""
this is the main algorithm code implementation of paper Multi-Task Learning as Multi-Objective Optimization
for more detail, we can see: https://github.com/isl-org/MultiObjectiveOptimization
