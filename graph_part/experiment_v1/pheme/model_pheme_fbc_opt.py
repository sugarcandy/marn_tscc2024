    ...
    def fit(self, X_train_tid, X_train, y_train,
        ...
        for epoch in range(self.config['epochs']):
            ...
            for idx, data in enumerate(dataloader):
                ...
                loss_data["classify"] = loss_classify.data
                ...
                loss_data["constractive"] = loss_cons.data
                loss_cons.backward()
                grads["constractive"] = []
                ...
                loss += scale["constractive"] * loss_cons_*0.12
                ...
                optimizer.step()
                corrects = (torch.max(prob_, 1)[1].view(batch_y.size()).data == batch_y.data).sum()
